...
- 웹페이지 품질을 측정하기 위한 오픈소스 자동화 도구로 웹페이지의 성능, 접근성 및 검색 엔진 최적화 요소를 감사
...
![](https://velog.velcdn.com/images/mintmin0320/post/5d2e7790-e820-49e4-96d2-6e617204d5cd/image.png)

- 58점 -> 77점 -> 89점으로 약 30점 정도 성능 점수가 향상되었다.
