---
title: '블로그 배경 변경 + 잡다한 UI 업데이트'
date: '2023-10-02'
tags: ['블로그_커스텀']
draft: false
summary: '내 입맛대로 블로그를 만들어보자'
---

해야 할 일들이 많지만 새벽에 내가 만든 블로그를 둘러보다가 너무 개성 없고 밋밋하다는 느낌을 받았다. 망설이지 않고 커스텀을 진행했으나 온갖 방해물을 만나며 고생했던 기록을 정리해 볼까 한다.
...
수정한 적도 없는 코드들이 말썽을 부리기 시작했다. 본인들은 수정해 주지 않아서 서운했던 것일까
...
에러가 계속 발생했을 때마다 육성으로 비명을 질렀다.

![](https://velog.velcdn.com/images/mintmin0320/post/411d2bdc-7bf9-4b20-a840-2d545a22344e/image.png)

마지막 배포 때는 1분 50초 동안 기도했다...
