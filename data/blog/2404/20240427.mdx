...
> - [이전 게시물: React 에러 핸들링을 해보자 - ErrorBoundary](https://mintmin-dev-world.vercel.app/blog/20231212)
...
1. `useSuspenseQuery`를 사용할 경우 **Suspense** 컴포넌트를 먼저 적용할 컴포넌트 상위에 래핑하고 사용하기 (**무한 루프 발생 위험**) - [참고](https://mintmin-dev-world.vercel.app/blog/20240202)
...
첫 시도로 **서버 컴포넌트 하위에 클라이언트 컴포넌트를 추가**해 이 문제를 해결하려 했으나 **불필요한 Dept**가 생기는 문제가 발생했다. 서버 컴포넌트는 많은 장점이 있지만, 역시 사용함에 있어 까다로운 부분이 있는 것 같다.
