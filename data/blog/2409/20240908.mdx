...
1. 프로젝트의 성격
   ...
   하지만, <b>미라클 한 기적이 없다고 판단해 React Query를 사용하지 않고 42 KB의 실리를 추구</b>하기로 했다.
...
import {
   useGetTransitList
} from '@/shared/provincial/api/queries/useGetTransitList'

const useTransitRoutes = () => {
...
export default useTransitRoutes
```
