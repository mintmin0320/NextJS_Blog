...
📌 HTTP OPTIONS 메서드: Preflight 요청은 HTTP ***OPTIONS*** 메서드를 사용하여 전송
📌 Access-Control-Request-Headers: 실제 요청에서 어떤 HTTP 헤더가 사용될지
📌 Access-Control-Request-Method: 실제 요청에서 어떤 HTTP 메서드 (예: POST, GET)가 사용될 것인지를 나타낸다.
📌 Origin: 요청이 출처를 나타낸다.
